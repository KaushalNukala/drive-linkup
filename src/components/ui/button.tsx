  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-border bg-background hover:bg-accent hover:text-accent-foreground shadow-soft transition-smooth",
        secondary:
        ...
        hero: "bg-gradient-primary text-white hover:scale-105 shadow-medium transition-bounce font-semibold",
        accent: "bg-accent text-accent-foreground hover:bg-accent/90 shadow-soft transition-smooth font-medium",
